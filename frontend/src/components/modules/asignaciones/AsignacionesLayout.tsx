...
import { useAsignacionesTable } from './logic/useAsignacionesTable';
import { useAsignacionesActions } from './logic/useAsignacionesActions';
import type { Asignacion } from './logic/types';
...
export default function AsignacionesLayout() {
  ...
  const {
    ...
    PAGE_SIZE,
    fetchAsignaciones,
  } = useAsignacionesTable();

  // Actions & toast
  const { toasts, removeToast, addToast, confirm, handleDelete, confirmDelete, cancelDelete } =
    useAsignacionesActions(fetchAsignaciones);
                ...
                return (
                  <tr key={a.id} className="hover:bg-white/[0.03] transition-colors">
                    ...
                    <td className="px-4 py-3">
                      ...
                      {a.docente?.user?.email && <p className="text-xs text-white/35">{a.docente.user.email}</p>}
                    </td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <button
                          onClick={() => handleDelete(a.id, deleteLabel)}
