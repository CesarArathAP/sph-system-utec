    ...
    <div className="p-4 sm:p-6 md:p-8 min-h-full bg-[#081028] text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-white">Grupos</h1>
            <p className="text-white/40 text-xs sm:text-sm">{total} grupos registrados</p>
          </div>
        </div>
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20 gap-3">
          ...
          <span className="text-white/30 text-sm">Cargando grupos...</span>
        </div>
      )}
                      ...
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg transition cursor-pointer
                            ${grupo.activo ? 'hover:bg-amber-500/20 text-amber-400' : 'hover:bg-emerald-500/20 text-emerald-400'}`}
